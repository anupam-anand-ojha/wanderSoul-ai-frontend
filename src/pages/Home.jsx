  ...
  return (
    <main className="bg-[#faf7ff] text-[#24152f]">
      ...
      <section className="relative min-h-svh overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-10 flex md:items-center px-6 pt-32 md:pt-20 md:px-10">
          <div className="mx-auto w-full max-w-7xl">
            <div className="max-w-3xl">
              ...
              <h1 className=" text-6xl md:text-5xl font-bold leading-[0.95] tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl">
                Your next
                <br />
              ...
              <p className="mt-10 md:mt-7 max-w-xl text-lg text-base leading-7 text-white/70 md:text-lg">
                ...
                wanderSoul AI creates a personalized journey from destinations
                to activities and everything in between made just for you.
              </p>
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-3">
            ...
            <div className="card border border-[#800080]/10 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:border-[#800080]/30 hover:shadow-lg hover:shadow-[#800080]/10">
              <div className="card-body">
                ...
                <h3 className="card-title text-[#24152f]">Personalized</h3>
            ...
            <div className="card border border-[#800080]/10 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:border-[#800080]/30 hover:shadow-lg hover:shadow-[#800080]/10">
              <div className="card-body">
                ...
                <h3 className="card-title text-[#24152f]">AI Powered</h3>

                <p className="text-sm leading-6 text-[#24152f]/60">
                  Get smart recommendations and complete day-by-day itineraries
                  in seconds.
                </p>
              </div>
            </div>
            ...
            <div className="card border border-[#800080]/10 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:border-[#800080]/30 hover:shadow-lg hover:shadow-[#800080]/10">
              <div className="card-body">
                ...
                <h3 className="card-title text-[#24152f]">Effortless</h3>

                <p className="text-sm leading-6 text-[#24152f]/60">
                  From destination ideas to daily plans, everything stays simple
                  and organized.
                </p>
              </div>
            </div>
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2">
            ...
            >
              ...
              <div className="absolute bottom-7 left-7 text-white">
                <p className="text-sm text-white/60">Indonesia</p>

                <h3 className="mt-1 text-4xl font-bold">Bali</h3>
            ...
            >
              ...
              <div className="absolute bottom-7 left-7 text-white">
                ...
                <h3 className="mt-1 text-4xl font-bold">Kashmir</h3>
      ...
      <section className="relative overflow-hidden border-y border-[#800080]/10 bg-gradient-to-br from-white via-[#faf7ff] to-[#f3e8ff] px-6 py-24 md:px-10 lg:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid gap-12 md:grid-cols-3">
            {/* Step 1 */}
            <div>
              <span className="text-sm font-bold text-[#800080]">01</span>
            ...
            {/* Step 2 */}
            <div>
              <span className="text-sm font-bold text-[#800080]">02</span>
              ...
              <p className="mt-3 text-base leading-7 text-[#24152f]/60">
                wanderSoul turns your preferences into a personalized day-by-day
                travel itinerary.
              </p>
            </div>
            ...
            {/* Step 3 */}
            <div>
              <span className="text-sm font-bold text-[#800080]">03</span>
