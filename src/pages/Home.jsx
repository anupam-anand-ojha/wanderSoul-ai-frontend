        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl font-bold leading-tight tracking-tight md:text-6xl">
              Plan less.
              <br />
              <span className="text-base-content/40">Experience more.</span>
            </h2>
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-3">
            ...
            <div className="card border border-base-content/10 bg-base-200 transition duration-300 hover:-translate-y-2 hover:border-primary/30">
              <div className="card-body">
                ...
                <h3 className="card-title">Effortless</h3>
          ...
          <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="text-4xl font-bold tracking-tight md:text-5xl">
                Places worth
                <span className="text-base-content/40"> getting lost in.</span>
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl font-bold tracking-tight md:text-6xl">
              From idea to
              <br />
              <span className="text-base-content/40">itinerary.</span>
            </h2>
          </div>
          ...
          <div className="mt-16 grid gap-12 md:grid-cols-3">
            ...
            <div>
              ...
              <h3 className="mt-4 text-2xl font-bold">Tell us your dream</h3>
            ...
            <div>
              ...
              <h3 className="mt-4 text-2xl font-bold">Let AI plan it</h3>
            ...
            <div>
              ...
              <h3 className="mt-4 text-2xl font-bold">Go live it</h3>
